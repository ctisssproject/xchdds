...
function getProgressLoading()
{
    ...
    o_ajax_request.setPage('it_ajax.svr.php');
...
<form method="post" id="upload_form_<?php echo($id)?>"
	action="bn_submit.svr.php?function=UploadTempFile"
