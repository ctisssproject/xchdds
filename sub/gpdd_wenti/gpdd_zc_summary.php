...
echo ($o_scroll->getZcSummaryList ($o_page));
?>
		<script type="text/javascript" language="javascript">
		function search()
		{
			if($('#Vcl_StartDate').val()=='' && $('#Vcl_EndDate').val()=='')
			{
				 parent.parent.Dialog_Message('请输入搜索条件 ！');
				 return;
			}
			location='gpdd_zc_summary.php?start='+$('#Vcl_StartDate').val()+'&end='+$('#Vcl_EndDate').val();
		}
	S_Root='../../';
