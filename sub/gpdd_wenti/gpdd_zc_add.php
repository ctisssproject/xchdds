...
<form method="post" id="dialog_form"
	action="include/bn_submit.svr.php?function=AddZc"
	enctype="multipart/form-data" target="ajax_submit_frame"
	style="width: 100%">
	<input type="hidden" name="Vcl_BackUrl" value="<?php echo(str_replace ( substr( $_SERVER['PHP_SELF'] , strrpos($_SERVER['PHP_SELF'] , '/')+1 ), '', $_SERVER['PHP_SELF']).'gpdd_zc_task.php')?>"/>
...
<table class="TableBlock_Editor" align="center" width="900"
	...
	<tbody>
		...
		<tr>
			<td class="TableData" nowrap="nowrap" width="120" style="vertical-align:top">发送对象（分组）：</td>
			<td class="TableData">
			<?php 
		...
		<tr>
			<td class="TableData" nowrap="nowrap" width="120" style="vertical-align:top">发送对象（学校）：</td>
			<td class="TableData">
				<?php 
		...
		<tr>
			<td class="TableData" nowrap="nowrap" width="120"
				style="vertical-align: top;">自查内容：</td>
