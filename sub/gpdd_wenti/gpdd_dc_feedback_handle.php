...
<form method="post" id="dialog_form"
	action="include/bn_submit.svr.php?function=DcFeedback"
...
<table class="TableBlock_Editor" align="center" width="900" style="margin-top:10px">
	<tbody>
		...
		<tr>
			<td class="TableData" nowrap="nowrap" width="120"
				style="vertical-align: top;"><strong>督查反馈：</strong></td>
		...
		<tr class="TableControl" align="center">
			...
			<textarea
				...
				<input value="提交" class="BigButtonA" onclick="dc_feedback()" type="button" />&nbsp;&nbsp;&nbsp;&nbsp;
