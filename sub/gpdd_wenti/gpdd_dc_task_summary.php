...
$o_table = new GPDD_Dc_Summary($_GET['id']);
?>
...
<form method="post" id="dialog_form"
	action="include/bn_submit.svr.php?function=DcSummary"
	...
	<tbody>
		...
		<tr>
			<td class="TableData" nowrap="nowrap" width="120"
				style="vertical-align: top;"><strong>汇总内容：</strong></td>
		...
		<tr class="TableControl" align="center">
			...
			<textarea
				...
				<input value="提交" class="BigButtonA" onclick="dc_summary()" type="button" />&nbsp;&nbsp;&nbsp;&nbsp;
