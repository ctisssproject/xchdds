...
<form method="post" id="dialog_form"
	action="include/bn_submit.svr.php?function=DcReject"
...
<table class="TableBlock_Editor" align="center" width="900" style="margin-top:10px">
	<tbody>
		...
		<tr>
			<td class="TableData" nowrap="nowrap" width="80" style="vertical-align: top;"><strong>督查组意见：</strong></td>
			<td class="TableData">
		...
		<tr>
			...
			<td class="TableData">
				<textarea class="BigInput" style="" name="Vcl_Reason2" id="Vcl_Reason2" rows="10" cols="50"><?php echo(AilterTextArea($o_table->getReason2()))?></textarea> <span class="red">如果退回，此项为必填项</span>
			</td>
		</tr>
		
		<tr class="TableControl" align="center">
			<td colspan="4" nowrap="nowrap" height="40">
				<input value="退回" class="BigButtonB" onclick="dc_reject()" type="button" style="color:red"/>&nbsp;&nbsp;&nbsp;&nbsp;
				<input value="确认完成" class="BigButtonB" onclick="dc_confirm(<?php echo($_GET['id'])?>,'<?php echo($_SERVER['HTTP_REFERER'])?>')" type="button" />&nbsp;&nbsp;&nbsp;&nbsp;
