...
function MyDisk_GetPath($folder_id) {
	global $O_Session;
	global $O_Request;
	require_once 'bn_operate.class.php';
	$o_operate = new Operate ();
	$o_operate->getFolderForMyDisk ( $folder_id);
...
function Directory_GetPath($folder_id) {
	global $O_Session;
	global $O_Request;
	require_once 'bn_operate.class.php';
	$o_operate = new Operate ();
	$o_operate->getFolderForDirectory ( $folder_id);
	$O_Request->setFunction ( 'callbackOpenPathDirectory' );	
	$O_Request->PushParameter ( $o_operate->getFolderName () );
	$O_Request->PushParameter ( $o_operate->getFolderId () );
	return $O_Request->getSendXml ();

}
function Share_GetRoot($folder_id) {
	global $O_Session;
	global $O_Request;
	require_once 'bn_operate.class.php';
	$o_operate = new Operate ();
...
function Share_GetPath($n_id) {
	...
	require_once 'bn_operate.class.php';
	$o_operate = new Operate ();
	$o_operate->getFolderForMyDisk ( $n_id );
	$O_Request->setFunction ( 'callbackOpenPathShare' );
	$O_Request->PushParameter ( $o_operate->getFolderName () );
	$O_Request->PushParameter ( $o_operate->getFolderId () );
	return $O_Request->getSendXml ();
