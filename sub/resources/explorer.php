    ...
    <table border="0" cellpadding="0" cellspacing="0" class="folder_top">
        <tr>
			...
			if ($n_folder_2_count==0)
			{
				echo('
			<td>
                <div class="upload" onclick="uploadFile('.$n_folder.')">
                </div>
            </td>
            <td>
                <div class="upload_link" onclick="uploadLink('.$n_folder.')">
                </div>
            </td>
            <td>
            ...
            <td style="width:90%; text-align:right;">
            	<input id="Vcl_Search" style="height:20px" onkeydown="if(event.keyCode==13){searchSubmit(<?php echo($n_folder)?>)}" name="Vcl_Search" size="40" maxlength="60" class="BigInput" type="text"/>
            </td>
            <td>
                <div class="search" onclick="searchSubmit(<?php echo($n_folder)?>)">
                </div>
            </td>
        </tr>
    </table>
