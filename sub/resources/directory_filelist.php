...
<div class="file_list">
<?php echo($o_filelist->getDirectoryFileList($n_folderid))?>    
</div>       
...
<script type="text/javascript" language="javascript">
	S_Root='../../';
	<?php 
		echo('parent.parent.document.getElementsByTagName(\'frame\')[0].contentWindow.refreshPathDirectory('.$n_folderid.');');
