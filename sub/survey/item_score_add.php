...
<input type="hidden" name="Ajax_FunName" value="ItemScoreAdd"/>
	...
	<tbody>
		...
		<tr>
			...
			<td class="TableData"><input id="Vcl_Content" name="Vcl_Content"
				class="BigInput" style="width:500px;" type="text"/>
				</td>
		</tr>
		<tr>
			<td class="TableData" nowrap="nowrap" width="120">分值：</td>
			<td class="TableData"><select name="Vcl_Score" id="Vcl_Score">
		...
		<tr class="TableControl" align="center">
			<td colspan="2" nowrap="nowrap" height="40"><input value="提交" class="BigButtonA"
				onclick="item_score_add()" type="button" />&nbsp;&nbsp;&nbsp;&nbsp;
