...
<table style="border: 1px dotted #CCCCCC; margin-top:30px;display:none">
	...
	<div class="centent" style="padding-top:35px;padding-left:15px;">
		<p><strong>(三) 干部队伍建设</strong></p>
	</div>    
	<?php 
	OutputItem(3,7);
	?> 
	<div class="centent" style="padding-top:35px;padding-left:15px;">
		<p><strong>(四) 教师队伍</strong></p>
	</div>    
	<?php 
	OutputItem(8,11);
	?> 
	<div class="centent" style="margin-top:40px;">
		<p><strong>三、管理工作</strong></p>
	</div>
	<div class="centent" style="padding-top:35px;padding-left:15px;">
		<p><strong>(五) 思想工作</strong></p>
	</div>
	<?php 
	OutputItem(12,13);
	?>
	<div class="centent" style="padding-top:35px;padding-left:15px;">
		<p><strong>(六) 教育活动管理</strong></p>
	</div>
	<?php 
	OutputItem(14,20);
	?>
	<div class="centent" style="padding-top:35px;padding-left:15px;">
		<p><strong>(七) 资源管理</strong></p>
	</div>
	<?php 
	OutputItem(21,24);
	?>
	<div class="centent" style="padding-top:35px;padding-left:15px;">
		<p><strong>(八) 教科研管理</strong></p>
	</div>
	<?php 
	OutputItem(25,25);
	?>
	<div class="centent" style="padding-top:35px;padding-left:15px;">
		<p><strong>(九) 安全管理</strong></p>
	</div>
	<?php 
	OutputItem(26,27);
	?>
	...
	<div class="centent" style="padding-top:35px;padding-left:15px;">
		<p><strong>(十) 工作绩效</strong></p>
	</div>
	<?php 
	OutputItem(28,28);
	?>
	<div class="centent" style="padding-top:35px;padding-left:15px;">
		<p><strong>(十一) 工作特色</strong></p>
	</div>
	<?php 
	OutputItem(29,29);
	?>
