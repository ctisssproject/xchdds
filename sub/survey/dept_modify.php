...
<input type="hidden" name="Ajax_FunName" value="DeptModify"/>
...
<table class="TableBlock_Editor" align="center" width="800" style="margin-top: 10px">
	<tbody>
		...
		<tr>
			...
			<td class="TableData"><?php echo($o_dept->getName())?>
				</td>
		</tr>
		<tr>
		...
		<tr class="TableControl" align="center">
			<td colspan="2" nowrap="nowrap" height="40"><input value="提交" class="BigButtonA"
				onclick="detp_modify()" type="button" />&nbsp;&nbsp;&nbsp;&nbsp;
...
<script type="text/javascript" language="javascript">
	...
	$('#Vcl_Uid').val('<?php echo($o_dept->getUid())?>');
