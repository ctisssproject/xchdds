...
<input type="hidden" name="Ajax_FunName" value="ItemScoreModify"/>
...
<table class="TableBlock_Editor" align="center" width="800" style="margin-top: 10px">
	<tbody>
		...
		<tr>
			...
			<td class="TableData">
				<select name="Vcl_Score" id="Vcl_Score">
...
<script type="text/javascript" language="javascript">
	S_Root='../../';
	$('#Vcl_Score').val('<?php echo($o_table->getScore());?>');
