...
<input type="hidden" name="Ajax_FunName" value="TypeModify"/>
	...
	<tbody>
		<tr>
			...
			<td class="TableData"><input id="Vcl_Number" name="Vcl_Number"
				class="BigInput" style="width:300px;" size="16" maxlength="30" type="text" value="<?php echo($o_table->getNumber())?>"/>
				</td>
		</tr>
		<tr>
			<td class="TableData" nowrap="nowrap" width="120">对象名称：</td>
			<td class="TableData"><input id="Vcl_Name" name="Vcl_Name"
				class="BigInput" style="width:300px;" size="16" maxlength="30" type="text" value="<?php echo($o_table->getName())?>"/>
				</td>
		</tr>
		<tr>
		...
		<tr class="TableControl" align="center">
			<td colspan="2" nowrap="nowrap" height="40"><input value="修改" class="BigButtonA"
				onclick="type_submit()" type="button" />&nbsp;&nbsp;&nbsp;&nbsp;
				<input value="返回" class="BigButtonA" onclick="location='<?php echo(str_replace ( substr( $_SERVER['PHP_SELF'] , strrpos($_SERVER['PHP_SELF'] , '/')+1 ), '', $_SERVER['PHP_SELF']))?>type.php'" type="button" />
				</td>
		</tr>
...
<script type="text/javascript" language="javascript">
	...
	$('#Vcl_Scope').val('<?php echo($o_table->getType())?>');
    </script>
</body>
</html>
