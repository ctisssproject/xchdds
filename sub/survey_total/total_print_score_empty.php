...
{
	echo ('<script>location=\'total_print_score_yey_empty.php?id='.$_GET['id'].'\'</script>');
}
if ($o_subject->getScpoe()==2)
{
	echo ('<script>location=\'total_print_score_xy_empty.php?id='.$_GET['id'].'\'</script>');
}
...
<table class="score_table" border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		...
		<?php getScoreSingle($o_item,$o_subject_item,20,true);?>
	</tr>
	<tr>
