...
function getScoreSingle($o_item,$o_subject_item,$n_number,$b=FALSE)
{
	...
	?>
		...
		<td>
			...
			<td>
			<?php $n_temp=getSumByType($o_subject_item,$o_item,($n_number-1),7); $sum1=$sum1+$n_temp;$total1=$total1+$n_temp;?>
			</td>
		<td>
			<?php $n_temp=getSumByType($o_subject_item,$o_item,($n_number-1),8);$sum2=$sum2+$n_temp;$total2=$total2+$n_temp;?>
			</td>
		<td>
			<?php $n_temp=getSumByType($o_subject_item,$o_item,($n_number-1),9);$sum3=$sum3+$n_temp;$total3=$total3+$n_temp;?>
			</td>
	<?php
}
...
<table border="0" class="score_table" cellpadding="0" cellspacing="0" style="margin-top: 10px;width:500px;">
	...
	<tr class="title">
		...
		?>
	<tr>
		<td rowspan="4" style="border-left: solid 1px #000000;">&nbsp;一.<br /><br />
		&nbsp;发&nbsp;<br /><br />
		&nbsp;展&nbsp;<br /><br />
		&nbsp;规&nbsp;<br /><br />
		&nbsp;划&nbsp;</td>
		<td rowspan="3" style="padding-top:10px;padding-bottom:10px;">（一）<br />
		规划<br />
		计划<br />
		的制<br />
		定与<br />
	...
	<tr>
		...
		<?php getScoreSingle($o_item,$o_subject_item,4,true);?>
	</tr>
	<tr>
...
<table border="0" class="score_table" cellpadding="0" cellspacing="0" style="margin-top: 10px;width:500px">
	<tr>
		<td rowspan="12" style="width: 50px;border-left: solid 1px #000000;border-top: solid 1px #000000;">&nbsp;&nbsp;三.&nbsp;<br /><br />
		&nbsp;各&nbsp;<br /><br />&nbsp;项&nbsp;<br /><br />&nbsp;工&nbsp;<br /><br />&nbsp;作&nbsp;<br /><br />&nbsp;管&nbsp;<br /><br />&nbsp;理&nbsp;
		</td>
		<td rowspan="6" style="width: 40px;border-top: solid 1px #000000;">（五）<br />
		卫生<br />保健<br />工作
		</td>
		<?php getScoreSingleTop($o_item,$o_subject_item,22);?>
	</tr>
	<tr>
	...
	?>
	<tr>
		<td rowspan="4" style="padding-top: 10px; padding-bottom: 10px;border-left: solid 1px #000000;">&nbsp;&nbsp;四.&nbsp;<br /><br />
		&nbsp;发&nbsp;<br />&nbsp;展&nbsp;<br />&nbsp;绩&nbsp;<br />&nbsp;效&nbsp;
		</td>
		<td rowspan="1">（八）<br />
		幼儿发<br />展水平<br />
		</td>
		<?php getScoreSingle($o_item,$o_subject_item,33,true);?>
	</tr>
	<tr>
		<td rowspan="2">（九）<br />
		园所<br />发展<br />水平
