            ...
            <tr>
                <td id="left">
                    <div class="Big" style="padding-top: 15px; padding-bottom: 15px">
                        <img src="../../images/ext_org/root.png" align="absmiddle"/>&nbsp;&nbsp;<span class="big3">部门管理</span>&nbsp;
                    </div>
                     <table class="BlockTop" width="100%">
                        <tbody>
                            <tr>
                                ...
                                <td class="center">
                                    <a href="dept_add.php" id="custom_folder1" class="header" target="diary_body">添加部门</a>
                                </td>
                                <td class="right">
                                </td>
                            </tr>
                    ...
                    <table class="BlockBottom BlockBottom_user">
                        <tbody>
                            <tr>
                                ...
                                <td class="center">
                                    <a href="dept_list.php" class="header" target="diary_body">部门列表</a>
                                </td>
                                <td class="right">
                                </td>
                            </tr>
                ...
                <td id="right">
                <div id="center">
                    <iframe id="diary_body" name="diary_body" src="dept_list.php" onload="jQuery(window).triggerHandler('resize');"
