		...
		for($i = 0; $i < $n_count; $i ++) {
			...
			$s_record_list .= '
				             <tr class="TableLine1">
					                ...
					                <td align="center" >
					                	<a href="javascript:;" onclick="location=\'zbtx_manage_level1_modify.php?id='.$o_term->getId ( $i ).'\'">修改</a>&nbsp;&nbsp;
					                	<a style="color:red" href="javascript:;" onclick="zbtx_manage_level1_delete('.$o_term->getId ( $i ).')">删除</a>&nbsp;&nbsp;
					                	<a href="javascript:;" onclick="location=\'zbtx_manage_level2_modify.php?level1_id='.$o_term->getId ( $i ).'\'">添加二级</a>
					                </td>
					            </tr>
			';
			...
			for($j = 0; $j < $o_level2->getAllCount (); $j ++) {
				$s_record_list .= '
				             <tr class="TableLine1">
					                ...
					                <td align="center" >
					                	<a href="javascript:;" onclick="location=\'zbtx_manage_level2_modify.php?id='.$o_level2->getId ( $j ).'\'">修改</a>&nbsp;&nbsp;
					                	<a style="color:red" href="javascript:;" onclick="zbtx_manage_level2_delete('.$o_level2->getId ( $j).')">删除</a>&nbsp;&nbsp;
					                	<a href="javascript:;" onclick="location=\'zbtx_manage_level3_modify.php?level2_id='.$o_level2->getId ( $j ).'\'">添加三级</a>
					                </td>
					            </tr>
				';
				...
				for($k = 0; $k < $o_level3->getAllCount (); $k ++) {
					$s_record_list .= '
					             <tr class="TableLine1">
						                ...
						                <td align="center" >
						                	<a href="javascript:;" onclick="location=\'zbtx_manage_level3_modify.php?id='.$o_level3->getId ( $k ).'\'">修改</a>&nbsp;&nbsp;
						                	<a style="color:red" href="javascript:;" onclick="zbtx_manage_level3_delete('.$o_level3->getId ( $k).')">删除</a>&nbsp;&nbsp;
						                </td>
						            </tr>
					';
				}
		...
		$s_html = '
			    <table class="small" border="0" cellpadding="3" cellspacing="0" width="100%" style="margin-bottom:5px">
			        <tbody>
			            <tr>
                			<td class="title">
			                    <input value="添加一级指标" class="BigButtonC"
				onclick="location=\'zbtx_manage_level1_modify.php?project_id='.$_GET['id'].'\'" type="button" />
