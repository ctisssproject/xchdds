...
echo ($o_scroll->getSummaryList ($o_page));
?>
		<script type="text/javascript" language="javascript">
		function search()
		{
			if($('#Vcl_Owner').val()=='' && $('#Vcl_StartDate').val()=='' && $('#Vcl_EndDate').val()=='')
			{
				 parent.parent.Dialog_Message('请输入搜索条件 ！');
				 return;
			}
			location='summary.php?owner='+$('#Vcl_Owner').val()+'&start='+$('#Vcl_StartDate').val()+'&end='+$('#Vcl_EndDate').val();
		}
	S_Root='../../';
