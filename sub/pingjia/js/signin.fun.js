...
function change_h_qu(obj)
{
	if (obj.value=="110102000000")
	{
		...
		document.getElementById("h_shequ").innerHTML='<div><label>户籍所在社区</label><select id="Vcl_H_Shequ" name="Vcl_H_Shequ"><option value="">请选择</option></select></div><div class="space10"></div>';
	}else{
		var value=obj.value
...
function change_h_jiedao(obj)
{
	if (obj.value=="")
	{
		var s_html='<div><label>户籍所在社区</label><select id="Vcl_H_Shequ" name="Vcl_H_Shequ"><option value="">请选择</option></select></div><div class="space10"></div>'
	...
	a_shequ.sort();
	var s_html='<div><label>户籍所在社区</label><select id="Vcl_H_Shequ" name="Vcl_H_Shequ"><option value="">请选择</option>'
	for(var i=0;i<a_shequ.length;i++)
	{
...
function change_z_jiedao(obj)
{
	if (obj.value=="")
	{
		var s_html='<div><label>现住址所在社区</label><select id="Vcl_Z_Shequ" name="Vcl_Z_Shequ"><option value="">请选择</option></select></div><div class="space10"></div>'
	...
	var a_shequ=JieDao[value];
	a_shequ.sort();
	var s_html='<div><label>现住址所在社区</label><select id="Vcl_Z_Shequ" name="Vcl_Z_Shequ"><option value="">请选择</option>'
	for(var i=0;i<a_shequ.length;i++)
	{
		s_html=s_html+'<option value="'+a_shequ[i]+'">'+a_shequ[i]+'</option>'
	}
	...
	if(documentType=='居民身份证'){
		...
		if(studentCardNo!="" || studentCardNo!=null){
		   if(studentCardNo.length != 15 && studentCardNo.length != 18){
		        ...
		        parent.parent.Dialog_Message("幼儿身份证号长度应为15或者18位")
		        return false;
		   }else{
		   		var newCardNoAdd = checkId(studentCardNo.toLowerCase());
				if("身份证输入错误！" == newCardNoAdd){
		        	parent.parent.Dialog_Message("幼儿身份证输入错误！");
		            return false;
		    	}
			    ...
			    {
					parent.parent.Dialog_Message("幼儿身份证号格式错误，只能由数字或X组成。");   
					return false;  
				}
		...
		if(studentCardNo==""){
	  		parent.parent.Dialog_Message("基本信息的 [证件号] 不能为空值！");
		  	return false;
	  	}
	  }
...
function check_1_id(){
	...
	if(documentType=='居民身份证'){
		...
		if(studentCardNo!="" || studentCardNo!=null){
		   if(studentCardNo.length != 15 && studentCardNo.length != 18){
		   		//document.getElementById("Vcl_Birthday").value="";
		        parent.parent.Dialog_Message("第一法定监护人信息的 [身份证] 长度应为15或者18位")
		        return false;
		   }else{
		   	
		   		var newCardNoAdd = checkId(studentCardNo.toLowerCase());
				if("身份证输入错误！" == newCardNoAdd){
		        	parent.parent.Dialog_Message("第一法定监护人信息的 [身份证] 输入错误！");
		            return false;
		    	}
		   		var sexValue = (newCardNoAdd.slice(14,17)%2 ? '男' : '女');
		      	var birthdayValue = newCardNoAdd.slice(6,10) +"-"+ newCardNoAdd.slice(10,12) +"-"+ newCardNoAdd.slice(12,14);
			    ...
			    if (!reg.test(studentCardNo))
			    {
					parent.parent.Dialog_Message("第一法定监护人信息的 [身份证] 格式错误，只能由数字或X组成。");   
					return false;  
				}
				//document.getElementById("Vcl_Sex").value=sexValue;
		   	}
	  	...
	  	var studentCardNo = document.getElementById("Vcl_ID").value.trim();
		if(studentCardNo==""){
	  		parent.parent.Dialog_Message("第一法定监护人信息的 [证件号] 不能为空值！");
		  	return false;
	  	}
	  }	 
}
function check_2_id(){
	...
	if(documentType=='居民身份证'){
		...
		if(studentCardNo!="" || studentCardNo!=null){
		   if(studentCardNo.length != 15 && studentCardNo.length != 18){
		   		//document.getElementById("Vcl_Birthday").value="";
		        parent.parent.Dialog_Message("第二法定监护人信息的 [身份证] 长度应为15或者18位")
		        return false;
		   }else{
		   		var newCardNoAdd = checkId(studentCardNo.toLowerCase());
				if("身份证输入错误！" == newCardNoAdd){
		        	parent.parent.Dialog_Message("第二法定监护人信息的 [身份证] 输入错误！");
		            return false;
		    	}
		   		var sexValue = (newCardNoAdd.slice(14,17)%2 ? '男' : '女');
		      	var birthdayValue = newCardNoAdd.slice(6,10) +"-"+ newCardNoAdd.slice(10,12) +"-"+ newCardNoAdd.slice(12,14);
			    ...
			    if (!reg.test(studentCardNo))
			    {
					parent.parent.Dialog_Message("第二法定监护人信息的 [身份证] 格式错误，只能由数字或X组成。");   
					return false;  
				}
				//document.getElementById("Vcl_Sex").value=sexValue;
		   	}
	  	...
	  	var studentCardNo = document.getElementById("Vcl_ID").value.trim();
		if(studentCardNo==""){
	  		parent.parent.Dialog_Message("第二法定监护人信息的 [证件号] 不能为空值！");
		  	return false;
	  	}
	  }	 
}
function submit_signin(modify)
{
	...
	if(modify=='false')
	{
		...
		{
			parent.parent.Dialog_Message("基本信息的 [幼儿姓名] 不能为空！")
	...
	if (document.getElementById("Vcl_Birthday").value=="")
		{
			parent.parent.Dialog_Message("基本信息的 [出生日期] 不能为空！")
	...
	if (document.getElementById("Vcl_Nationality").value == "中国") {
		if (document.getElementById("Vcl_Only").value=="是")
		{
			...
			{ 
				parent.parent.Dialog_Message("基本信息的 [独生子女证号] 不能为空！")
		...
		if (document.getElementById("Vcl_IsDibao").value == "是") {
			if (document.getElementById("Vcl_DibaoCode").value == "") {
				parent.parent.Dialog_Message("基本信息的 [低保证号]不能为空 ！")
		...
		if (document.getElementById("Vcl_IsCanji").value == "是") {
			if (document.getElementById("Vcl_CanjiType").value == "") {
				parent.parent.Dialog_Message("请选择基本信息的 [残疾幼儿类别] ！")
				document.getElementById("Vcl_CanjiType").focus()
				return
			}
			if (document.getElementById("Vcl_CanjiCode").value == "") {
				parent.parent.Dialog_Message("基本信息的 [幼儿残疾证号] 不能为空！")
	...
	//{
		//parent.parent.Dialog_Message("请填写 [入园日期]！");
		//return;
	//}

	if (document.getElementById('Vcl_ClassId').value=="")
	{
		parent.parent.Dialog_Message("请选择 [入园班级]！");
		return;
	}	
	if (document.getElementById("Vcl_IsYiwang").value=="是")
	{
		...
		{
			parent.parent.Dialog_Message("请选择基本信息的 [以往病史] ！")
	...
	if (document.getElementById("Vcl_IsShoushu").value=="是")
	{
		...
		{
			parent.parent.Dialog_Message("健康信息的 [手术名称] 不能为空！")
	...
	if (document.getElementById("Vcl_IsGuomin").value=="是")
	{
		...
		{
			parent.parent.Dialog_Message("健康信息的 [过敏源] 不能为空！")
	...
	if (document.getElementById("Vcl_IsYichuan").value=="是")
	{
		...
		{
			parent.parent.Dialog_Message("健康信息的 [家族遗传病史名称] 不能为空！")
	...
	if (document.getElementById("Vcl_Nationality").value == "中国") {
		...
		if (document.getElementById("Vcl_C_City").value == "") {
			parent.parent.Dialog_Message("请选择户籍信息的 [出生所在（省/市）] ！")
		...
		if (document.getElementById("c_area").innerHTML != "") {
			if (document.getElementById("Vcl_C_Area").value == "") {
				parent.parent.Dialog_Message("请选择户籍信息的 [出生所在（市/区）] ！")
		...
		if (document.getElementById("c_street").innerHTML != "") {
			if (document.getElementById("Vcl_C_Street").value == "") {
				parent.parent.Dialog_Message("请选择户籍信息的 [出生所在（区/县）] ！")
		...
		{
			parent.parent.Dialog_Message("请选择户籍信息的 [户籍所在（省/市）] ！")
		...
		if (document.getElementById("h_qu").innerHTML != "") {
			if (document.getElementById("Vcl_H_Area").value == "") {
				parent.parent.Dialog_Message("请选择户籍信息的 [户籍所在（市/区）] ！")
		...
		if (document.getElementById("h_jiedao").innerHTML != "") {
			if (document.getElementById("Vcl_H_Street").value == "") {
				...
				{
					parent.parent.Dialog_Message("请选择户籍信息的 [户籍所在街道] ！")
				}
				else
				{
					parent.parent.Dialog_Message("请选择户籍信息的 [户籍所在（区/县）] ！")
				}
				document.getElementById("Vcl_H_Street").focus()
				return
			}
	...
	if(document.getElementById("Vcl_Z_Same").value=="否")
	{
		if (document.getElementById("Vcl_Z_City").value=="北京市" && document.getElementById("Vcl_Z_Area").value=="西城区")
		{
			...
			{
				parent.parent.Dialog_Message("请选择现住址信息的 [现住址所在街道]！")
				document.getElementById("Vcl_Z_Street").focus()
				return
			}
			if (document.getElementById("Vcl_Z_Shequ").value=="")
			{
				parent.parent.Dialog_Message("请选择现住址信息的 [现住址所在社区]！")
		...
		{
			parent.parent.Dialog_Message("现住址信息的 [现住址详细地址] 不能为空！")
	...
	{
		parent.parent.Dialog_Message("现住址信息的 [产权人姓名] 不能为空！")
		document.getElementById("Vcl_Z_Owner").focus()
		return
	}
	if (document.getElementById("Vcl_Jh_1_Name").value=="")
	{
		parent.parent.Dialog_Message("第一法定监护人信息的 [姓名] 不能为空！")
	...
	if (check_1_id()==false)
	{
		document.getElementById("Vcl_Jh_1_ID").focus()
		return
	}
	
	if (document.getElementById("Vcl_Jh_1_Job").value=="")
	{
		parent.parent.Dialog_Message("请选择第一法定监护人信息的 [职业状况] ！")
		document.getElementById("Vcl_Jh_1_Job").focus()
		return
	}
	if (document.getElementById("Vcl_Jh_1_Danwei").value=="")
	{
		parent.parent.Dialog_Message("第一法定监护人信息的 [工作单位全称] 不能为空！")
		document.getElementById("Vcl_Jh_1_Danwei").focus()
		return
	}
	if (document.getElementById("Vcl_Jh_1_Jiaoyu").value=="")
	{
		parent.parent.Dialog_Message("请选择第一法定监护人信息的 [教育程度] ！")
		document.getElementById("Vcl_Jh_1_Jiaoyu").focus()
		return
	}
	if (document.getElementById("Vcl_Jh_1_Phone").value=="")
	{
		parent.parent.Dialog_Message("第一法定监护人信息的 [联系电话] 不能为空！")
	...
	if (document.getElementById("Vcl_Jh_1_IsCanji").value=="是")
	{
		if (document.getElementById("Vcl_Jh_1_CanjiCode").value=="")
		{
			//parent.parent.Dialog_Message("第一法定监护人信息的 [残疾证号] 不能为空！")
			//document.getElementById("Vcl_Jh_1_CanjiCode").focus()
			//return
		}
	}
	...
	if (document.getElementById("Vcl_Jh_2_Name").value != "") {//如果第二法定监护人姓名不是空，那么
		if (document.getElementById("Vcl_Jh_2_Connection").value == "") {
			parent.parent.Dialog_Message("请选择第二法定监护人信息的 [关系] ！")
			document.getElementById("Vcl_Jh_2_Connection").focus()
			return
		}
		if (document.getElementById("Vcl_Jh_2_Name").value == "") {
			parent.parent.Dialog_Message("第二法定监护人信息的 [姓名] 不能为空！")
			document.getElementById("Vcl_Jh_2_Name").focus()
			return
		}
		if (document.getElementById("Vcl_Jh_2_IdType").value == "") {
			parent.parent.Dialog_Message("请选择第二法定监护人信息的 [证件类型] ！")
			document.getElementById("Vcl_Jh_2_IdType").focus()
			return
		}
		if (check_2_id() == false) {
			document.getElementById("Vcl_Jh_2_ID").focus()
			return
		}
		if (document.getElementById("Vcl_Jh_2_IsZhixi").value == "") {
			parent.parent.Dialog_Message("请选择第二法定监护人信息的 [是否是直系亲属] ！")
			document.getElementById("Vcl_Jh_2_IsZhixi").focus()
			return
		}
		if (document.getElementById("Vcl_Jh_2_Job").value == "") {
			parent.parent.Dialog_Message("请选择第二法定监护人信息的 [职业状况] ！")
			document.getElementById("Vcl_Jh_2_Job").focus()
			return
		}
		if (document.getElementById("Vcl_Jh_2_Danwei").value=="")
		{
			parent.parent.Dialog_Message("第二法定监护人信息的 [工作单位全称] 不能为空！")
			document.getElementById("Vcl_Jh_2_Danwei").focus()
			return
		}
		if (document.getElementById("Vcl_Jh_2_Jiaoyu").value == "") {
			parent.parent.Dialog_Message("请选择第二法定监护人信息的 [教育程度] ！")
			document.getElementById("Vcl_Jh_2_Jiaoyu").focus()
			return
		}
		if (document.getElementById("Vcl_Jh_2_Phone").value == "") {
			parent.parent.Dialog_Message("第二法定监护人信息的 [联系电话] 不能为空！")
			document.getElementById("Vcl_Jh_2_Phone").focus()
			return
		}
		if (document.getElementById("Vcl_Jh_2_IsCanji").value == "") {
			parent.parent.Dialog_Message("请选择第二法定监护人信息的 [是否残疾] ！")
			document.getElementById("Vcl_Jh_2_IsCanji").focus()
			return
		}
		if (document.getElementById("Vcl_Jh_2_IsCanji").value == "是") {
			if (document.getElementById("Vcl_Jh_2_CanjiCode").value == "") {
			//parent.parent.Dialog_Message("第二法定监护人信息的 [残疾证号] 不能为空！")
			//document.getElementById("Vcl_Jh_2_CanjiCode").focus()
			//return
			}
		}
	}
	...
	if (modify)
	{
		parent.parent.Dialog_Confirm("修改信息后会进入审核！<br/>是否继续？",function(){document.getElementById("submit_form").submit();})
	}else{
...
function audit_student()
{
	...
	{
		parent.parent.Dialog_Confirm("该幼儿信息和其他幼儿园存在重复，批准后将由学前科审核，是否继续？",function (){parent.parent.Common_OpenLoading();document.getElementById('submit_form_2').submit();});
	}else{
		parent.parent.Dialog_Confirm("真的要批准这个幼儿的信息吗？",function (){parent.parent.Common_OpenLoading();document.getElementById('submit_form_2').submit();});
	}
