...
<?php echo($o_filelist->getShareFileList($n_folderid,$_GET ['uid']))?>           
    </table>
...
<script type="text/javascript" language="javascript">
	...
	if($_GET ['uid']>0)
	{
		echo('parent.parent.document.getElementsByTagName(\'frame\')[0].contentWindow.refreshPathShareUser('.$_GET ['uid'].');');
	}else{
		echo('parent.parent.document.getElementsByTagName(\'frame\')[0].contentWindow.refreshPathShare('.$n_folderid.');');
	}	
	?>
    </script>
</body>
